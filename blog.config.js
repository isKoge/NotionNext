...
const BLOG = {
  AUTHOR: 'KoGe', // 作者
  BIO: '一个爱干饭的程序员🍚', // 作者简介
  LINK: 'https://www.shipangshuo.xyz', // 网站地址
  ...
  CONTACT_EMAIL: 'ikoge@outlook.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/isKoge',
  CONTACT_TELEGRAM: '',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '记录、学习、分享', // 站点描述，被notion中的页面描述覆盖
