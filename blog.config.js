...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2189998397d080cea2cbe8a2bba61334,
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '空格', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '好好吃🍚，好好睡💤', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.shipangshuo.xyz', // 网站地址
